...
/**
* @see \App\Http\Controllers\Web\ProductController::bulk
* @see app/Http/Controllers/Web/ProductController.php:75
* @route '/{business}/products/bulk'
*/
export const bulk = (args: { business: string | { slug: string } } | [business: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/{business}/products/bulk'
*/
bulk.url = (args: { business: string | { slug: string } } | [business: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions) => {
...
* @route '/{business}/products/bulk'
*/
bulk.post = (args: { business: string | { slug: string } } | [business: string | { slug: string } ] | string | { slug: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: bulk.url(args, options),
    method: 'post',
})
