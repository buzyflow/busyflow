...
* @see app/Http/Controllers/Api/ProductController.php:34
...
* @see app/Http/Controllers/Api/ProductController.php:43
* @route '/api/products/{product}'
*/
...
* @see app/Http/Controllers/Api/ProductController.php:63
* @route '/api/products/{product}'
*/
